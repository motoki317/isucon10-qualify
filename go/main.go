...
func postEstate(c echo.Context) error {
	...
	for _, row := range records {
		...
		_, err := tx.Exec("INSERT INTO estate(id, name, description, thumbnail, address, latitude, longitude, rent, door_height, door_width, features, popularity, latlon) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,ST_GeomFromText("+point+"))", id, name, description, thumbnail, address, latitude, longitude, rent, doorHeight, doorWidth, features, -popularity)
		if err != nil {
